...
class RBMultiRangeTest : public benchmark::Fixture {
public:
...
BENCHMARK_DEFINE_F(RBMultiRangeTest, RangeQuery)(benchmark::State& state) {
...
BENCHMARK_REGISTER_F(RBMultiRangeTest, RangeQuery)
